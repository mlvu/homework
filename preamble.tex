...
\definecolor{mydarkgreen}{HTML}{0B5D18}
...
\hypersetup{colorlinks=true,linkcolor=myred,urlcolor=myred}
\usepackage{float}
\usepackage{enumitem}
\usepackage{bm}
...
\newcommand{\dgc}[1]{{\textcolor{mydarkgreen}{#1}}}
\newcommand{\bc}[1]{{\textcolor{myblue}{#1}}}
\newcommand{\kc}[1]{{\textcolor{mygray}{#1}}}
\newcommand{\oc}[1]{{\textcolor{myorange}{#1}}}
\newcommand{\pc}[1]{{\textcolor{mypurple}{#1}}}
\newcommand{\yc}[1]{{\textcolor{myyellow}{#1}}}

% \newcommand{\ans}[2]{{\leavevmode\color{mydarkgreen}#2}} % no answers
\newcommand{\ans}[2]{{\leavevmode\color{mydarkgreen}#1}} % answers
